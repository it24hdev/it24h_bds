        ...
        <div class="snap-drawer snap-drawer-right">
            ...
            <div class="login_sidebar">
                ...
                <div class="login_form" id="register-div-mobile">
                    ...
                    <input autofocus="" class="form-control" id="user_login_register_mobile" name="user_login_register" placeholder="Username" type="text">
                ...
                <div class="login_form" id="forgot-pass-div-mobile">
                    ...
                    <div class="loginrow">
                        <input autofocus="" class="form-control" id="forgot_email_mobile" name="forgot_email" placeholder="Enter Your Email Address" size="20" type="email">
                        </input>
                    </div>
