    ...
    <div class="modal_login_container " style="height:550px;">
        ...
        <div class="login-register-modal-form-wrapper">
            ...
            <div class="login_form" id="register-div-topbar">
                ...
                <input autofocus="" class="form-control" id="user_login_register_topbar" name="user_login_register" placeholder="Username" type="text">
            ...
            <div class="login_form" id="forgot-pass-div">
                ...
                <div class="loginrow">
                    <input autofocus="" class="form-control" id="forgot_email_topbar" name="forgot_email" placeholder="Enter Your Email Address" size="20" type="email">
                    </input>
                </div>
